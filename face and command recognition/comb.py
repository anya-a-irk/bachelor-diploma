...
config.set_string('-dict', '/home/anna/diplom/comb_2/speech/vocabular.dict')
config.set_string('-jsgf', '/home/anna/diplom/comb_2/speech/sp.jsgf')
...
while True:
    ...
    if user_name != "":
        ...
        print("произнесите пароль или отмена")
        while voice_command == "":
            voice_command = ""
            ret, frame = cap.read()
            ...
            if buf:
                ...
                break
            if voice_command != "":
                if voice_command == "пароль диплом":
                    print("доступ разрешен")
                elif voice_command == "отмена":
